---
title: "A natural account of loss aversion"
author: |
...
```{r loss-aversion-setup, echo = FALSE, include=FALSE, eval = !isTRUE(get0("PARENT_RMD_EXISTS"))}
rm (list=ls())
...
```{r loss-aversion-load-libraries, include = FALSE, message = TRUE, warning = TRUE, eval = !isTRUE(get0("PARENT_RMD_EXISTS"))}
...
```{r loss-aversion-define-ws-for-demos, eval = !isTRUE(get0("PARENT_RMD_EXISTS"))}
...
```{r loss-aversion-loss-aversion-demo-setup, eval = !isTRUE(get0("PARENT_RMD_EXISTS"))}
...
```{r loss-aversion-loss-aversion-demo-create-data, eval = !isTRUE(get0("PARENT_RMD_EXISTS"))}
