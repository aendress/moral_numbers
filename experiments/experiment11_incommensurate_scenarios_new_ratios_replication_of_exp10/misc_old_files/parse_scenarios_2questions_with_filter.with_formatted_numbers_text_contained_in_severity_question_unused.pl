...
sub print_scenario
{
  ...
  # The severity and the acceptability questions are now separate

  # 1. (Single) severity question - Start
  push (@out_lines,
	("[[Question:Matrix]]",
  ...
  # 1. (Single) severity question - End
  
  # 2. Acceptability question - Start
